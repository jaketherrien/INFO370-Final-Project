...
Our small p-value (.00003558)  and relatively high t-value indicate we can safely accept the alternate hypothesis. Findings show there is a relationship between the average amount of money spent and average SAT scores. Below are some predictions made with our linear model:
